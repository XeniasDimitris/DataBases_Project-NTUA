function fillDatabase(db) {
    ...
    sql = "INSERT INTO `Baseis2019`.`belongs_to` (`ISBN`, `categoryName`) VALUES" +
        ...
        "('978-1-60309-062-9', 'Comics')," +
        "('978-1-60309-301-9', 'Drawing')," +
        "('978-1-60309-322-4', 'Cartoon')," +
    ...
    sql = "INSERT INTO `Baseis2019`.`written_by` (`ISBN`, `authID`) VALUES" +
        ...
        "('978-1-60309-322-4', 9566)," +
        "('978-1-60309-375-0', '9569')," +
        "('978-1-60309-386-6', '9571')," +
        ...
        //Reminder Imports
    /*sql = "INSERT INTO `Baseis2019`.`reminder` (`empID`, `memberID`, `ISBN`, `copyNr`, `date_of_borrowing`, `date_of_reminder`) VALUES" +
        "(1, 1, '978-1-891830-90-7', 7, '2019-05-02', '2019-05-17')," +
        ...
        "(9, 7, '978-1-60309-047-6', 6, '2019-04-15', '2019-05-15')," +
        "(9, 10, '978-1-60309-047-6', 6, '2019-05-04', '2019-06-04')," +
        "(11, 4, '978-1-891830-75-4', 4, '2019-04-06', '2019-04-06');"
        db.query(sql,(err,results)=>{
            if (err) throw err;
