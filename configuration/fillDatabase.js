function fillDatabase(db) {
    ...
    sql = "INSERT INTO `Baseis2019`.`borrows` (`memberID`, `ISBN`, `copyNr`, `date_of_borrowing`) VALUES" +
        ...
        "(10, '978-1-60309-375-0', 11,'2018-05-04')," +
        "(1, '978-1-60309-013-1', 4, '2019-04-15')," +
        "(1, '978-1-60309-025-4', 4, '2019-04-15')," +
        "(1, '978-1-60309-050-6', 8, '2019-04-15');" ;
        db.query(sql,(err,results)=>{
            if (err) throw err100;
        });
    //Category Imports
    ...
    sql = "INSERT INTO `Baseis2019`.`written_by` (`ISBN`, `authID`) VALUES" +
        ...
        //Reminder Imports
    sql = "INSERT INTO `Baseis2019`.`reminder`  VALUES" +
        "(1, 1, '978-1-891830-90-7', 7, '2019-05-02', '2019-05-11')," +
