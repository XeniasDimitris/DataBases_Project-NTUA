...
router.get('/belongs_to',belongs_to_controller.belongs_to_delete_get);
router.get('/books',books_controller.books_delete_get);
router.get('/borrows',borrows_controller.borrows_delete_get);
...
router.get('/permanent_employees',permanent_employees_controller.permanent_employees_delete_get);
router.get('/publishers',publishers_controller.publishers_delete_get);
router.get('/reminder',reminder_controller.reminder_delete_get);
router.get('/temporary_employees',temporary_employees_controller.temporary_employees_delete_get);
router.get('/written_by',written_by_controller.written_by_delete_get);


// POST ROUTERS
router.post('/authors',authors_controller.authors_delete_post);
router.post('/belongs_to',belongs_to_controller.belongs_to_delete_post);
router.post('/books',books_controller.books_delete_post);
router.post('/borrows',borrows_controller.borrows_delete_post);
...
router.post('/permanent_employees',permanent_employees_controller.permanent_employees_delete_post);
router.post('/publishers',publishers_controller.publishers_delete_post);
router.post('/reminder',reminder_controller.reminder_delete_post);
router.get('/temporary_employees',temporary_employees_controller.temporary_employees_delete_post);
